...
$ curl 'http://localhost:8080/auth/logout' -i -X PATCH \
    ...
    -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdXRoIjoiUk9MRV9VU0VSIiwic3ViIjoiZW1haWxAZ21haWwuY29tIiwiZXhwIjoxNzA4NTg4OTIyLCJpYXQiOjE3MDg1ODcxMjJ9.4XMY5CqP2eFpv5zZKT7AyNckdcIcGlaatHn4JRvWH7I' \
