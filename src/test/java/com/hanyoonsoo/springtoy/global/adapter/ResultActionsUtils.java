...
public class ResultActionsUtils {
    ...
    public static ResultActions deleteRequestWithTokenAndParam(MockMvc mockMvc, String url, String accessToken, String encryptedRefreshToken, String imageUrl) throws Exception {
        return mockMvc.perform(delete(url)
                        .contentType(MediaType.APPLICATION_JSON_VALUE)
                        .header(AUTHORIZATION_HEADER, BEARER_PREFIX + accessToken)
                        .header(REFRESH_HEADER, encryptedRefreshToken)
...
//    public static ResultActions postRequestWithFilesAndToken(MockMvc mockMvc, String url, String accessToken, String encryptedRefreshToken, List<MultipartFile> multipartFiles) throws Exception {
//        MultipartHttpServletRequestBuilder builder = (MockMultipartHttpServletRequestBuilder) MockMvcRequestBuilders.multipart(url)
//                .header(AUTHORIZATION_HEADER, BEARER_PREFIX + accessToken)
//                .header(REFRESH_HEADER, encryptedRefreshToken)
